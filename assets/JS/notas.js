...
document.querySelector(".m1").addEventListener("click", () => trocarMusica(musicas.musica1));
document.querySelector(".m2").addEventListener("click", () => trocarMusica(musicas.musica2));
document.querySelector(".m3").addEventListener("click", () => trocarMusica(musicas.musica3));
document.querySelector(".m4").addEventListener("click", () => trocarMusica(musicas.musica4));
